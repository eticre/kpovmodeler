...
void PMRenderManager::restoreConfig()
{
   QSettings qset;
   qset.beginGroup( "Rendering" );
   m_backgroundColor = qset.value( "BackgroundColor" ).value<QColor>();
   m_graphicalObjectColor[0] = qset.value( "GraphicalObjectColor0" ).value<QColor>();
   m_graphicalObjectColor[1] = qset.value( "GraphicalObjectColor1" ).value<QColor>();
   m_controlPointColor[0] = qset.value( "ControlPointColor0" ).value<QColor>();
   m_controlPointColor[1] = qset.value( "ControlPointColor1" ).value<QColor>();
   m_axesColor[0] = qset.value( "AxesColorX" ).value<QColor>();
   m_axesColor[1] = qset.value( "AxesColorY" ).value<QColor>();
   m_axesColor[2] = qset.value( "AxesColorZ" ).value<QColor>();
   m_gridColor = qset.value( "GridColor" ).value<QColor>();
   m_gridDistance = qset.value( "GridDistance" ).value<int>();
   m_fieldOfViewColor = qset.value( "FieldOfViewColor" ).value<QColor>();
   m_highDetailCameraView = qset.value( "HighDetailCameraViews" ).value<bool>();
}
