...
void PMViewLayoutManager::loadData()
{
   ...
   QString fileName = QStandardPaths::locate(QStandardPaths::GenericDataLocation, "kpovmodeler/viewlayouts.xml" );
   if( fileName.isEmpty() )
   {
...
{
   QString fileName = QStandardPaths::writableLocation(QStandardPaths::GenericDataLocation) + QLatin1Char('/') + "kpovmodeler/viewlayouts.xml" ;
   if( fileName.isEmpty() )
   {
